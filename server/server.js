...
const possiblePaths = [
  path.join(__dirname, '../dist'),                                           // relative (zip upload)
  '/home/u873522560/domains/graminkcart.in/nodejs/dist',                    // absolute fixed
  path.join(__dirname, '../../dist'),                                        // ek aur level upar
];
