...
import BulkImportModal from './BulkImportModal';   // ← yeh line add karo
...
export default function ProductList() {
  ...
  const [showImport, setShowImport] = useState(false);   // ← yeh line add karo
    ...
    <div style={{ fontFamily: "'DM Sans', sans-serif", background: '#F8F9FB', minHeight: '100vh' }}>
      ...
      <div style={{ background: '#fff', borderBottom: '1px solid #EAECF0', padding: '14px 28px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <button onClick={() => setShowImport(true)} style={greenBtnStyle}>   {/* ← yeh add karo */}
            📥 Bulk Import
          </button>
