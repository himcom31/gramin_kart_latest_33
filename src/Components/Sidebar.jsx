    ...
    <div className="w-[280px] h-screen bg-white border-r border-gray-100 flex flex-col overflow-y-auto custom-scrollbar">
      ...
      <div className="flex-1 px-4 py-4 space-y-1">
        ...
        <NavItem
          ...
          icon={<Tag size={20} />}
          label="Brands"
          active={isActive('/admin/brandpage')}
        />
        ...
        <NavItem
          ...
          active={isActive('/admin/pusernotication')}
        />
        ...
        <DropdownNavItem
          ...
          defaultOpen={isAnyActive([
            '/admin/texs',
            '/admin/deliveryCharge',
          ])}
          items={[
            { label: 'Vat & taxes', path: '/admin/texs' },
            { label: 'Delivery Charge', path: '/admin/deliveryCharge' },
          ]}
          isActive={isActive}
        />
...
const NavItem = ({ to, icon, label, active, giftIcon }) => (
  <Link to={to}>
